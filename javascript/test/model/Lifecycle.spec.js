...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplitMerger.Lifecycle();
  });
  ...
  describe('Lifecycle', function() {
    it('should create an instance of Lifecycle', function() {
      ...
      //var instane = new SplitMerger.Lifecycle();
      //expect(instance).to.be.a(SplitMerger.Lifecycle);
    });

    it('should have the property actionTime (base name: "actionTime")', function() {
