...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplitMerger.ActionSettings();
  });
  ...
  describe('ActionSettings', function() {
    it('should create an instance of ActionSettings', function() {
      // uncomment below and update the code to test ActionSettings
      //var instane = new SplitMerger.ActionSettings();
      //expect(instance).to.be.a(SplitMerger.ActionSettings);
    });
