...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplitMerger.SplitSettings();
  });
  ...
  describe('SplitSettings', function() {
    it('should create an instance of SplitSettings', function() {
      // uncomment below and update the code to test SplitSettings
      //var instane = new SplitMerger.SplitSettings();
      //expect(instance).to.be.a(SplitMerger.SplitSettings);
    });
    ...
    it('should have the property deliveryFormat (base name: "deliveryFormat")', function() {
      // uncomment below and update the code to test the property deliveryFormat
      //var instane = new SplitMerger.SplitSettings();
      //expect(instance).to.be();
    });

    it('should have the property splitPages (base name: "splitPages")', function() {
      // uncomment below and update the code to test the property splitPages
      //var instane = new SplitMerger.SplitSettings();
      //expect(instance).to.be();
    });
