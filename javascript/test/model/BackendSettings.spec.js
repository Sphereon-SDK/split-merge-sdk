...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplitMerger.BackendSettings();
  });
  ...
  describe('BackendSettings', function() {
    it('should create an instance of BackendSettings', function() {
      // uncomment below and update the code to test BackendSettings
      //var instane = new SplitMerger.BackendSettings();
      //expect(instance).to.be.a(SplitMerger.BackendSettings);
    });
