...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SplitMerger.FileEntry();
  });
  ...
  describe('FileEntry', function() {
    it('should create an instance of FileEntry', function() {
      // uncomment below and update the code to test FileEntry
      //var instane = new SplitMerger.FileEntry();
      //expect(instance).to.be.a(SplitMerger.FileEntry);
    });
