...
(function(root, factory) {
  ...
  describe('Job', function() {
    it('should create an instance of Job', function() {
      ...
      //var instane = new SplitMerger.Job();
      //expect(instance).to.be.a(SplitMerger.Job);
    });
    ...
    it('should have the property actionSettings (base name: "actionSettings")', function() {
      // uncomment below and update the code to test the property actionSettings
      //var instane = new SplitMerger.Job();
      //expect(instance).to.be();
    });
