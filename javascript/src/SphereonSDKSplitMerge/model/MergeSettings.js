...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SplitMerger.MergeSettings = factory(root.SplitMerger.ApiClient, root.SplitMerger.Lifecycle);
  }
   ...
   * @module SphereonSDKSplitMerge/model/MergeSettings
   * @version 0.1
   */

  /**
   * Constructs a new <code>MergeSettings</code>.
   * @alias module:SphereonSDKSplitMerge/model/MergeSettings
   * @class
   * @param deliveryFormat {module:SphereonSDKSplitMerge/model/MergeSettings.DeliveryFormatEnum} format which will be returned when the result is requested
   * @param fileFormat {module:SphereonSDKSplitMerge/model/MergeSettings.FileFormatEnum} the format of the output file
   */
   ...
   * @param {module:SphereonSDKSplitMerge/model/MergeSettings} obj Optional instance to populate.
   * @return {module:SphereonSDKSplitMerge/model/MergeSettings} The populated <code>MergeSettings</code> instance.
   */
   ...
   * @member {module:SphereonSDKSplitMerge/model/MergeSettings.DeliveryFormatEnum} deliveryFormat
   */
  exports.prototype['deliveryFormat'] = undefined;
  /**
   * the format of the output file
   * @member {module:SphereonSDKSplitMerge/model/MergeSettings.FileFormatEnum} fileFormat
   */
