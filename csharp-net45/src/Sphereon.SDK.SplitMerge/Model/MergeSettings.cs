...
namespace Sphereon.SDK.SplitMerge.Model
{
    ...
    public partial class MergeSettings :  IEquatable<MergeSettings>
    {
        ...
        public MergeSettings(Lifecycle Lifecycle = null, DeliveryFormatEnum? DeliveryFormat = null, FileFormatEnum? FileFormat = null)
        {
            // to ensure "DeliveryFormat" is required (not null)
            if (DeliveryFormat == null)
            {
                throw new InvalidDataException("DeliveryFormat is a required property for MergeSettings and cannot be null");
            }
            else
            {
            ...
            if (FileFormat == null)
            {
                throw new InvalidDataException("FileFormat is a required property for MergeSettings and cannot be null");
            }
            else
            {
