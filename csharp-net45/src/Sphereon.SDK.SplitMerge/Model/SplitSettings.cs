...
namespace Sphereon.SDK.SplitMerge.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SplitSettings :  IEquatable<SplitSettings>
    {
        /// <summary>
        /// format which will be returned when the result is requested
        /// </summary>
        /// <value>format which will be returned when the result is requested</value>
        ...
        /// </summary>
        /// <value>the format of the output file</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitSettings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SplitSettings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SplitSettings" /> class.
        /// </summary>
        /// <param name="Lifecycle">Lifecycle.</param>
        /// <param name="DeliveryFormat">format which will be returned when the result is requested (required).</param>
        /// <param name="SplitPages">SplitPages.</param>
        /// <param name="FileFormat">the format of the output file (required).</param>
        public SplitSettings(Lifecycle Lifecycle = null, DeliveryFormatEnum? DeliveryFormat = null, List<int?> SplitPages = null, FileFormatEnum? FileFormat = null)
        {
            // to ensure "DeliveryFormat" is required (not null)
            if (DeliveryFormat == null)
            {
                throw new InvalidDataException("DeliveryFormat is a required property for SplitSettings and cannot be null");
            }
            else
            {
            ...
            if (FileFormat == null)
            {
                throw new InvalidDataException("FileFormat is a required property for SplitSettings and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets SplitPages
        /// </summary>
        [DataMember(Name="splitPages", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SplitPages: ").Append(SplitPages).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SplitSettings);
        }

        /// <summary>
        /// Returns true if SplitSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of SplitSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SplitSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.SplitPages == other.SplitPages ||
                    this.SplitPages != null &&
                    this.SplitPages.SequenceEqual(other.SplitPages)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SplitPages != null)
                    hash = hash * 59 + this.SplitPages.GetHashCode();
